...
export default function LoginPage() {
    ...
    return (
        <main className="h-full w-full flex items-center justify-center bg-primary">
            <form autoComplete="off" className="h-full max-h-[25rem] min-w-[23rem] max-w-[25rem] rounded-md bg-secondary p-4 flex flex-col items-center justify-center gap-4 shadow-[0px_0px_10px_0px_#2a4365]" onSubmit={handleSubmit}>
